...
def compute_tDCF(bonafide_score_cm, spoof_score_cm, Pfa_asv, Pmiss_asv,
    ...
    where CM stands for countermeasure and ASV for automatic speakerverification. The CM is therefore used as a 'gate' to decided whether or
    ...
    o     You should provide real-valued soft scores, NOT hard decisions. The
          ...
          This, however, is NOT required. The scores can have arbitrary rangeand scaling.
